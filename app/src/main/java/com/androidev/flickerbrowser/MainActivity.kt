...
//    }
    ...
    override fun onDownloadComplete(data: String, status: DownloadStatus) {
        if (status == DownloadStatus.OK) {
            ...
            getFlickrJsonData.execute(data) // actual call
//            getFlickrJsonData.execute("Bogus data")   // test call to check error
        } else {
            // download failed
    ...
    override fun onError(exception: Exception) {
        Log.e(TAG, "onError called with exception ${exception.message}")
    }
